            ...
            <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                                        ...
                                        {{-- <li class="py-2 mb-1 border-bottom">
                                            <a href="javascript:void(0);" class="d-flex">
                                                <img class="avatar rounded-circle"
                                                    src="{{ asset('saleperson/images/xs/avatar1.svg') }}" alt="">
                ...
                <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                    <div class="u-info me-2">
                        <p class="mb-0 text-end line-height-sm "><span class="font-weight-bold">{{ __(Auth::guard('saleperson')->user()->name) }}</span></p>
                        {{-- <small>saleperson Profile</small> --}}
                    </div>
                    ...
                    <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                        <div class="card border-0 w280">
                            <div class="card-body pb-0">
                                <div class="d-flex py-1">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <p class="mb-0"><span class="font-weight-bold">{{ __(Auth::guard('saleperson')->user()->name) }}</span></p>
                                        <small class="">{{ __(Auth::guard('saleperson')->user()->email) }}</small>
                                    </div>
                                </div>
                                <div>
                            ...
                            <div class="list-group m-2 ">
                                ...
                                <a href="{{ route('saleperson.logout') }}" class="list-group-item list-group-item-action border-0 "><i class="icofont-logout fs-5 me-3"></i>Signout</a>
                            </div>
                        </div>
                    </div>
                </div>
