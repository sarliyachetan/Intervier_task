       ...
       <div class="navbar-header">
          ...
          <div class="d-flex align-items-center">
             ...
             <div class="dropdown ms-sm-3 header-item topbar-user">
                ...
                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ __(Auth::guard('saleperson')->user()->name) }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                   <!-- item-->
                   <h6 class="dropdown-header">Welcome {{ __(Auth::guard('saleperson')->user()->name) }}!</h6>
                  
                   <a class="dropdown-item" href="{{ route('saleperson.logout') }}"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                </div>
             </div>
          </div>
       </div>
